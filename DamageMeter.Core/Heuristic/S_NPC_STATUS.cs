...
namespace DamageMeter.Heuristic
{
    ...
    {
        public static S_NPC_STATUS Instance => _instance ?? (_instance = new S_NPC_STATUS());
        private static S_NPC_STATUS _instance;

        public S_NPC_STATUS() : base(OpcodeEnum.S_NPC_STATUS) { }
