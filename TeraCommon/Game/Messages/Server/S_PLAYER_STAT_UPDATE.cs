namespace Tera.Game.Messages
{
    public class S_PLAYER_STAT_UPDATE : ParsedMessage
    {
        internal S_PLAYER_STAT_UPDATE(TeraMessageReader reader) : base(reader)
        {
            ...
            if (reader.Version < 319000 || reader.Version > 319900) reader.Skip(4);//probably hp/mp now either int64 or double, not sure, ignoring it until we get hp more than fit in int32
            MpRemaining = reader.ReadInt32();
            if (reader.Version < 319000 || reader.Version > 319900) reader.Skip(4);
            reader.Skip(4);
